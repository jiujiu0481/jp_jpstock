<template>
	<view class="page_bg">
		...
		<view class="top">
			<view class="top-list" @click="$u.route({url:'/pages/trade/ipo/CoinRecord'});">
				<view class="top-left"><img :src="$icon.ipo1">抽選申し込み履歴</view>
				<img :src="$icon.yjt1" class="top-right">
			</view>
			<view class="top-list" @click="$u.route({url:'/pages/trade/ipo/CoinRecord?curTab=1'});">
		...
		<view style="margin-top: 10px;">
			<CoinTradeIPOList ref="list"></CoinTradeIPOList>
		</view>
	</view>
...
<script>
	...
	import CoinTradeIPOList from './components/CoinTradeIPOList.vue';
	export default {
		components: {
			HeaderThird,
			CoinTradeIPOList,
