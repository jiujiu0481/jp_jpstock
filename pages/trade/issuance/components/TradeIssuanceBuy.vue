<template>
	<view>
		...
		<view class="common_popup" style="min-height:35vh;margin:auto;border-radius: 10px;">
			<view class="popup_header" style="background-color: #fa0c33;border-radius: 10px 10px 0px 0px;">
				{{info.name}}
				<image src="/static/close.png" mode="aspectFit" :style="$theme.setImageSize(30)"
			...
			<view style="padding:30rpx;">
				...
				<view class="bold text-center" style="margin: 30rpx auto;width: 80%;background-color: #fa0c33;padding: 15px; font-size: 18px; color: #fff;border-radius: 30px;" @tap.stop="handleConfirm()">
					{{$lang.BTN_CONFIRM}}
				</view>
			</view>
		</view>
