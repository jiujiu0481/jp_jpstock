	...
	<view>
		...
		<template v-else>
			<block v-for="(item,index) in list" :key="index">
				...
				<view style="margin:10rpx;padding: 20rpx; background-color: #f6f8fc;border-radius:10rpx;font-size: 12px;box-shadow: rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px;">
