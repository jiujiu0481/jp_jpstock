			...
			<view>
				...
				<view style="background-color: #FFFFFF; padding: 20px   0   10px  0;margin-top: 10px;">
					<view class="menu">
						...
						<view class="menu-item" @click="$u.route({url:'/pages/trade/ea/CoinIndex'});"
							style="margin-top: 12px;">
			...
			<view class="page">
				...
				<view style="background-color: #FFFFFF;padding: 20rpx 10px;min-height:96vh;border-radius: 10px;">
					...
					<template v-if="curTab == 0">
						<CoinTradeRecord></CoinTradeRecord>
					</template>

					<template v-if="curTab == 1">
						<CoinDepositRecord></CoinDepositRecord>
					</template>

					<template v-if="curTab == 2">
						<CoinWithdrawalRecord></CoinWithdrawalRecord>
					</template>
...
<script>
	...
	import CoinTradeRecord from './CoinTradeRecord.vue';
	import CoinDepositRecord from './CoinDepositRecord.vue';
	import CoinWithdrawalRecord from './CoinWithdrawalRecord.vue';
	export default {
		components: {
			HeaderSecond,
			TabsThird,
