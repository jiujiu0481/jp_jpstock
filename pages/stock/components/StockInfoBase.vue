<template>
	<view
		...
		<!-- 股票 概况 数值 布局 之 一行一项 -->
		<view
			style="line-height:1.6;padding:20rpx;border-radius: 5px;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;">
			<view style="display:flex;align-items: center;padding:4px 0;">
				<view style="flex:30%;" :style="{color:$theme.LOG_LABEL}">前日終値</view>
		...
		<!-- 布局 之 一行两项 -->
		<view style="background-color: #FFFFFF;border-radius: 6px;margin-top: 10px;">
			<view
			...
			<view
				...
				<view
					...
					<view style="color:#333;" :style="{color:$theme.PRIMARY}">
