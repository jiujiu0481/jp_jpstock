				...
				<view class="common_block" style="border-radius: 16rpx;">
					<view style="display: flex;align-items: center;">
						...
						<view
							...
							{{item.mode==0? $lang.COIN_PRICE_TYPE_MARKET:$lang.COIN_PRICE_TYPE_LIMIT}}
						</view>
						<view :style="setStyle(item.type)">
							{{item.type==0? $lang.COIN_VIEW_BTN_BUY:$lang.COIN_VIEW_BTN_SELL}}
						</view>
						<view style="margin-left: auto;" :style="{color:'#B8B8B8'}">
							{{$lang.COIN_HISTORY_TIP_TRADE}}
						</view>
					</view>
