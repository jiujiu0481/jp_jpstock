...
// export const  // 用户协议 、版本更新

export const SEARCH = `/pages/search/index`; // 搜索 
export const NOTIFICATION = `/pages/notification`; // 通知 

export const ACCOUNT_WITHDRAW = `/pages/account/withdraw`; // 出金
export const ACCOUNT_DEPOSIT = `/pages/deposit/index`; // 入金
export const TRANSACTION = `/pages/transaction/index`; // 账户交易记录
...
export const ACCOUNT_ZHUANHUAN = `/pages/account/zhuanhuan`; // 余额转换
export const ACCOUNT_HUAZHUAN = `/pages/account/huazhuan`; 
...
export const TRADE_IPO_RECORD = `/pages/trade/ipo/record`; // ipo交易 記錄[申請|中簽]
...
export const TRADE_ISSUANCE_RECORD = `/pages/trade/issuance/record`; // 新股配售 記錄[申請|中簽]

// 包含各种Stock、Coin、Follow 等。
...
export const POSITION = `/pages/position/index`; // 持仓